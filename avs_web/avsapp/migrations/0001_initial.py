# Generated by Django 3.2.5 on 2021-09-28 16:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('proj_start_date', models.DateField(help_text='Please specify project dates (even if approximately)', null=True, verbose_name='Start date')),
                ('proj_end_date', models.DateField(help_text='Please specify project dates (even if approximately)', null=True, verbose_name='End date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('industry_type', models.CharField(max_length=200, verbose_name='1.7. What industry does the company work in? (choose all appropriate answers)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.UUIDField(default=uuid.UUID('8d0684bf-6d6c-4dea-a8dc-ca7eb177302b'), editable=False, unique=True)),
                ('create_time', models.DateTimeField(auto_now_add=True)),
                ('invitation_status', models.CharField(choices=[('0', 'None'), ('1', 'Accept'), ('2', 'Waiting'), ('3', 'Backup'), ('4', 'Refuse')], default='0', max_length=1, verbose_name='Consultant Invitation Status')),
                ('payment_status', models.CharField(choices=[('0', 'Waiting'), ('1', 'Accept'), ('2', 'Refuse'), ('3', 'Payed')], default='0', max_length=1, verbose_name='Client Payment Status')),
                ('update_time', models.DateTimeField(auto_now=True)),
                ('bid_price', models.IntegerField(blank=True, null=True, verbose_name='Bid Price(£):')),
                ('invitaiton_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='avsapp.consultant')),
                ('invitation_event', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='avsapp.clientserviceenquiryform')),
            ],
        ),
    ]
